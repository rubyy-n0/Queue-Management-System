...
const businesses = {
    clinic: [{ id: "clinic_aiu", name: "Clinic AIU" }],
    bank: [{ id: "bank_maybank", name: "Maybank" }],
    restaurant: [{ id: "restaurant_mamak", name: "Mamak Restaurant" }],
    salon: [{ id: "salon_beauty", name: "Beauty Salon" }]
};
